        ...
        <div class="container hotthread">
            <div class="slider">
                ...
                <el-carousel indicator-position="outside" :autoplay="false" arrow="never" height="630px">
                    <el-carousel-item v-for="(item, index) in hotTravel" :key="index">
                        <ul class="item">
                            <li v-for="ele in item" :key="ele.id">
                                <div class="header">
                                    <div class="pic">
                                        <img   referrerpolicy="no-referrer" :src="ele.pic" alt="">
                                    </div>
                                    <div class="like total_replies">
                                        <!-- <i class="iconfont icon-xinxi iconfont-home"></i> -->
                                        <el-icon class="iconfont icon-xinxi iconfont-home"><ChatSquare /></el-icon>
                    ...
                    <!-- <div class="header">
                                <div class="pic">
                                    <img src="https://pic.qyer.com/album/user/4072/62/RUlSQBwFYk4/index/480x320" alt="">
                                </div>
                                <div class="like total_replies"><i class="iconfont-home icon-huifu"></i><span>8</span>
                                </div>
                            </div>
                            <div class="bottom">
                                <div class="info">
...
import { getHotTravel } from '@/api/index.js'
import { ChatSquare } from '@element-plus/icons-vue'
let hotTravel = reactive([]);
// 获取当前热门城市
const GetgetHotTravel = async () => {
    let res = await getHotTravel()
    hotTravel = res.data.data;
    console.log('汇总清单列表---', hotTravel);
}
